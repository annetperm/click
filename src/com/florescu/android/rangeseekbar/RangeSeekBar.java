...
package com.florescu.android.rangeseekbar;
...
import com.florescu.android.util.BitmapUtil;
import com.florescu.android.util.PixelUtil;
import com.messme.R;
...
public class RangeSeekBar<T extends Number> extends ImageView {
    ...
    protected synchronized void onDraw(@NonNull Canvas canvas) {
        ...
        if (mShowLabels) {
            ...
            String minLabel = getContext().getString(R.string.AgeFrom);
            String maxLabel = getContext().getString(R.string.AgeTo);
